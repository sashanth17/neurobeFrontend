                ...
                <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                    ...
                    <div className="panel">
                        <div className="mb-5 flex items-center justify-between">
                            ...
                            <button onClick={() => toggleCode('code1')} className="font-semibold hover:text-[#000] dark:text-[#000] dark:hover:text-[#000]">
        ...
        <svg>...</svg>
                    ...
                    <div className="panel">
                        <div className="mb-5 flex items-center justify-between">
                            ...
                            <button onClick={() => toggleCode('code2')} className="font-semibold hover:text-[#000] dark:text-[#000] dark:hover:text-[#000]">
                                <span className="flex items-center">
                                    <IconCode className="me-2" />
                                    Code
                                </span>
        ...
        <svg>...</svg>
                    ...
                    <div className="panel relative">
                        <div className="mb-5 flex items-center justify-between">
                            ...
                            <button onClick={() => toggleCode('code3')} className="font-semibold hover:text-[#000] dark:text-[#000] dark:hover:text-[#000]">
                                <span className="flex items-center">
                                    <IconCode className="me-2" />
                                    Code
                                </span>
                ...
                <SwiperSlide key={i}>
                    ...
                    <div className="panel">
                        <div className="mb-5 flex items-center justify-between">
                            ...
                            <button onClick={() => toggleCode('code4')} className="font-semibold hover:text-[#000] dark:text-[#000] dark:hover:text-[#000]">
                                <span className="flex items-center">
                                    <IconCode className="me-2" />
                                    Code
                                </span>
        ...
        <svg>...</svg>
                    ...
                    <div className="panel lg:col-span-2">
                        <div className="mb-5 flex items-center justify-between">
                            ...
                            <button onClick={() => toggleCode('code5')} className="font-semibold hover:text-[#000] dark:text-[#000] dark:hover:text-[#000]">
                                <span className="flex items-center">
                                    <IconCode className="me-2" />{' '}
                                    Code
                                </span>
